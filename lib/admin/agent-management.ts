...
// ── Local routines ────────────────────────────────────────────────────────
// Cleared 2026-08-27: the 8 registered Claude Desktop scheduled-tasks that were
// running on David's MacBook Pro were deleted from the scheduler (policy: no
// routines on laptops). Backup at ~/.claude/scheduled-tasks-backup-20260827-*,
// and each task's SKILL.md was left on disk. When routines are re-established on
// the Mac mini, add them back here with host: "mac-mini" (or wire a heartbeat
// so this reads live).
