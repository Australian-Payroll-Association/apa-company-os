...
// Recruiter-editable structured fields. `ai_salary_expectation` is written by
// the resume screener, not this editor, so it is not in this list.
export const CANDIDATE_SENSITIVE_FIELDS = [
