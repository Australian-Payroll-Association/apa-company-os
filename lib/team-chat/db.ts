...
const BLOCKED_TABLE =
  /\b(?:people_sensitive|compensation|performance_reviews|one_on_ones|goals|applications|candidates|candidate_profile|survey_responses|survey_answers|audit_log)\b/i;
