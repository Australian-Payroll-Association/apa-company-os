...
const BLOCKED_TABLE =
  /\b(?:people_sensitive|compensation|performance_reviews|one_on_ones|goals|applications|candidates|candidate_profile|survey_responses|survey_answers|audit_log|coaching_profiles|coaching_one_on_ones|coaching_commitments|coaching_checkins|coaching_trends|coaching_context|coaching_goals|coaching_priorities|coaching_ocean_profiles|coaching_goal_comments)\b/i;
