        ...
        await resend.emails.send({
          ...
          html: `
            ...
            <table style="border-collapse:collapse;font-family:sans-serif;font-size:15px;margin-bottom:20px">
              <tr><td style="padding:6px 16px 6px 0;color:#666;width:160px">Family</td><td><strong>${esc(family_name)}</strong></td></tr>
            ...
            <table style="border-collapse:collapse;font-family:sans-serif;font-size:14px;margin-bottom:20px">
              <tr><td style="padding:4px 16px 4px 0;color:#666;width:160px">Flight</td><td>${esc(body.inbound_flight || '—')}</td></tr>
