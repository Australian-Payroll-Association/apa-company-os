...
const STYLES = `
.cbp { --pri-now:#465778; --pri-next:#0b8f63; --pri-later:#4a505a; --pri-park:#b06508; max-width: 880px; }
.cbp .cbp-intro { background:rgba(70,87,120,.08); border-radius:10px; padding:14px 16px; font-size:14px; margin:0 0 16px; }
...
.cbp .cbp-step { font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.04em; padding:3px 9px; border-radius:99px; background:rgba(70,87,120,.1); color:#465778; }
...
.cbp .cbp-item.dragging { box-shadow:0 8px 24px rgba(16,16,20,.14); border-color:#465778; }
...
.cbp .cbp-handle:hover { color:#465778; }
.cbp .cbp-main { flex:1; min-width:0; }
.cbp .cbp-item-top { display:flex; gap:9px; align-items:flex-start; flex-wrap:wrap; }
.cbp .cbp-ref { flex:none; font-size:12px; font-weight:700; color:#465778; background:rgba(70,87,120,.1); border-radius:6px; padding:3px 7px; }
...
.cbp .cbp-pill:hover { border-color:#465778; color:#465778; }
...
.cbp .cbp-chip.tok { color:#465778; border-color:rgba(70,87,120,.15); background:rgba(70,87,120,.08); }
...
.cbp .cbp-btn { font-family:inherit; font-size:13px; font-weight:600; cursor:pointer; border-radius:99px; padding:8px 16px; border:1px solid #465778; background:#465778; color:#fff; }
.cbp .cbp-btn.ghost { background:#fff; color:#465778; }
.cbp .cbp-link { font-size:12px; font-weight:600; color:#465778; background:none; border:none; cursor:pointer; padding:0; font-family:inherit; }
